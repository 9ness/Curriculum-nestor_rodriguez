...
└── DESPLIEGUE.md       → Cómo publicarla en Vercel en 2 minutos
...
1. Rellenar en `cv/datos.json` y en la web: **teléfono, LinkedIn y GitHub**.
2. Desplegar la web (ver `web/DESPLIEGUE.md`) y crear la Access Key gratis del formulario.
3. Elegir 3-5 empresas de `research/empresas-y-ofertas.md` y decirme *"adapta mi CV a esta oferta: …"*.
